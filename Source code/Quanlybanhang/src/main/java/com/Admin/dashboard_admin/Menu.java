...
public class Menu extends JPanel {
    ...
    private JLabel lblProfile, lblHome, lblCustomer, lblOrder, lblCategory, lblProduct, lblExport, lblStatistics, lblMessage, lblExit, lblMenu, lblImport, lblStock, lblInsurance;
...
//                "Title_icon.png", 20, 20, 260, 55, true);
        ...
        lblExit= createLabel("Exit", "exit.png", 760);
